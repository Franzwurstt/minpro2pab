...
Desain Kartu Responsif: Menampilkan produk dalam bentuk kotak-kotak (Grid Card) menggunakan widget Wrap, sehingga tampilannya rapi baik saat dibuka di PC maupun di HP.
...
Di menu sebelah kiri, klik Project Settings (ikon gir paling bawah).
